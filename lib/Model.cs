...
namespace lib
{
    public class Model
    {
        ...
        public static Model Load(byte[] content)
        {
            var r = content[0];
        ...
        public Model(bool[,,] voxels)
        {
            this.voxels = voxels;
            R = voxels.GetLength(0);
        }

        public Model(params string[] zLayers)
        {
            this.R = zLayers.Length;
        ...
        public bool this[Vec coord]
        {
            get => voxels[coord.X, coord.Y, coord.Z]; set => voxels[coord.X, coord.Y, coord.Z] = value;
        }
        public bool this[int x, int y, int z]
        {
            get => voxels[x, y, z]; set => voxels[x, y, z] = value;
        }
    }
}